export default {
  ...
  HomePage_Top_Description:
    "Outsource your finance and accounting services with our top teams!",
  ...
  HowWeWork_JobBased_Description:
    "In our Job-Based Model, which focuses on completing tasks on a project-by-project basis, we act as your delivery partner to ensure efficient turnaround times. We will work with your teams to seamlessly integrate new work and processes, ensuring delivery within the agreed scope and time frames. This is a fixed fee arrangement, where we absorb the job margin risk for you. This suits clients looking to pass on overflow work during busy periods or would like to focus more on the growth of their business and less time managing staff.",
  Title_SuccessfulClientProjectsAndCounting:
  ...
  People1_Description:
    "The advantage of employing Swivel is that we’ve been able to be a bit more proactive with our suppliers. Mazzei was able to pay suppliers in a timely manner whilst developing the operations with the extended team in hopes of continuing for a more long-term engagement.",
  People1_Name: "Peter Tsantis",
  People1_Job: "CFO - Mazzei",
  People2_Description:
    "I've had a very positive experience with Swivel Group. At CharterNet, we needed to expand our team to handle the workload for our clients, and Swivel Group helped us identify and onboard exceptional team members to meet that need. We're committed to treating our offshore staff as equals to our onshore team members, and Swivel Group has been an invaluable partner in facilitating that approach. They handle the logistics of running a great office, while we manage the people as if they were here with us. This helps to create a sense of inclusion and teamwork, as if our offshore staff were simply working from home like many of their onshore colleagues. I'm thrilled about the prospect of continuing to work with Swivel Group as we continue to grow and expand.",
  People2_Name: "Ernest Chunge",
  People2_Job: "Head of Finance Function at CharterNet Advisors",
  People3_Description:
    "We have worked with Swivel for over 2 years now and the level and quality of candidates they have provided are of the highest standard. Really enjoy working with the Swivel team on all facets and look forward to building a valuable support team with their guidance and assistance.",
  ...
  ThoughtLeadership_Description:
    "Explore our curated collection of thought leadership pieces in the finance realm, showcasing Swivel Finances innovative solutions and expertise with insightful white papers designed to inform and inspire.",
  ...
  PopUp_Description_WeValueYourPrivacy:
