export default {
  ...
  TheResult_DescriptionForProject2:
    "Our client was able to build a full-fledged accounting support team through Swivel Finance employing Finance Managers, Senior and Junior Accountants with Australian accounting experience to help manage the finance function and the tax advisory division alleviating pressure and supporting time-critical tasks to free up the local team to focus on client-facing requirements.",
  ...
  TheSolution_DescriptionForProject3:
    "Swivel Finance recognized the need for immediate and targeted support. To address the client's challenges, we designed a customized solution via establishing a fully managed team comprised of specialists in accounts payable and accounts receivable. This dedicated team worked directly with the client to tackle the backlogs and streamline their financial processes.",
