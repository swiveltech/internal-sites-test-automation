export default {
  Top_Header: "About Us",
  Top_Description1:
    "As a leading software consultancy headquartered in Melbourne, Australia, we have a proven track record of delivering exceptional solutions to businesses worldwide. With over 200 successful projects under our belt, we've established a reputation for excellence, innovation, and strong partnerships.",
  Top_Description2:
    "Our team of experienced professionals are dedicated to helping businesses of all sizes achieve their goals. We specialise in a wide range of software development and IT consulting services, tailored to meet your unique needs.",
  ...
  OurPeopleIsOurBusiness_Description:
    "At Swivel we operate on the core values of:",
  SubTitle_Trust: "Trust",
  Trust_Description: "Confidence, Transparency and Honesty",
  SubTitle_Innovation: "Innovation",
  Innovation_Description:
    "Collaboration, Growth-oriented and Constantly Challenging",
  ...
  MeetTheLeaders_Description:
    "Our leadership team is dedicated to fostering a culture of innovation and excellence. With a wealth of experience and a passion for technology, they drive SwivelTech forward, pushing the boundaries of what’s possible.",
  ...
  Tile2_Description:
    "Our Elegance office buzzed with celebration for our 5th anniversary! We reminisced with a throwback video, heard inspiring messages from directors and HOD’s, and enjoyed cake and gifts for the whole crew.",
