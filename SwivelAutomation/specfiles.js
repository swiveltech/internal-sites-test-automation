...
const specConfig = [
  {
    specs: [
      ...
      // "../test/scripts/SwivelTech/tc_Cookie.js",
      // "../test/scripts/SwivelTech/tc_Newsroom.js",
      // "../test/scripts/SwivelTech/tc_PrivacyPolicy.js",
      // "../test/scripts/SwivelTech/tc_Sitemap.js",
    ],
    testingPlan: "smoke",
    maxInstances: 1,
  },
